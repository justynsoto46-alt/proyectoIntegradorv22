...
async function cargarParticipanteRetorno(){
    ...
    try{
        ...
        const participante = await obtenerDatos(`/api/participantes/${idParticipante}`);
    ...
    if(validarCamposVacios() === false &&
       ...
       validarProfesion() === false){
        ...
        try{
            ...
            const datosRespuesta = await actualizarDatos(`/api/participantes/${idParticipante}`, datosActualizados);
