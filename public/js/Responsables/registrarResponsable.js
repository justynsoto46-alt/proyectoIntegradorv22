...
async function registrarResponsableRetorno() {
    ...
    // El área todavía no se pide en este formulario; se completa
    // después desde la pantalla de modificación.
    const responsable = {
    ...
    try{
        ...
        const datosRespuesta = await crearDatos("/api/responsables", responsable);
